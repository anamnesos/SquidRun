...
- Switch from safety/plumbing to usefulness: produce a real/useful New Mira dry-run answer and compare it with current Mira, with no live send or route flip.
