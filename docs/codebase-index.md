...
| `mira/runtime/src/model-status.ts` | source | ` M` | 5658 |
...
| `mira/runtime/src/server.ts` | source | ` M` | 12511 |
...
| `mira/runtime/src/turn.ts` | source | ` M` | 12125 |
...
| `mira/ui/app.js` | source | ` M` | 18094 |
| `mira/ui/index.html` | asset | ` M` | 3836 |
| `mira/ui/styles.css` | asset | ` M` | 8758 |
...
| `ui/__tests__/mira-runtime-bridge-api.test.js` | test | ` M` | 70807 |
