...
| `mira/runtime/src/model-adapter.ts` | source | `clean/tracked` | 15414 |
...
| `mira/runtime/src/server.ts` | source | ` M` | 10628 |
...
| `mira/runtime/src/work-task.ts` | source | `??` | 10473 |
...
| `mira/ui/app.js` | source | ` M` | 12728 |
| `mira/ui/index.html` | asset | ` M` | 2936 |
| `mira/ui/styles.css` | asset | `clean/tracked` | 7453 |
| `mira/voice/review/.gitkeep` | config | `clean/tracked` | 1 |
| `mira/voice/voice-lab-v0.jsonl` | jsonl | `clean/tracked` | 15384 |
...
| `ui/__tests__/mira-runtime-bridge-api.test.js` | test | ` M` | 54429 |
