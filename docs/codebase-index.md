...
| `.gitignore` | config | `clean/tracked` | 3647 |
...
| `mira/runtime/src/server.ts` | source | `clean/tracked` | 8367 |
...
| `mira/runtime/src/voice-correction.ts` | source | `clean/tracked` | 2264 |
| `mira/runtime/src/voice-lab.ts` | source | `clean/tracked` | 6383 |
...
| `mira/voice/voice-lab-v0.jsonl` | jsonl | `clean/tracked` | 11900 |
...
| `ui/__tests__/mira-runtime-bridge-api.test.js` | test | ` M` | 30967 |
...
| `ui/__tests__/mira-voice-correction-capture.test.js` | test | `clean/tracked` | 3677 |
