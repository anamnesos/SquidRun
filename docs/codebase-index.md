...
| `mira/runtime/src/model-adapter.ts` | source | ` M` | 9927 |
...
| `mira/ui/app.js` | source | ` M` | 6537 |
| `mira/ui/index.html` | asset | ` M` | 1930 |
| `mira/ui/styles.css` | asset | ` M` | 3840 |
...
| `ui/__tests__/mira-runtime-bridge-api.test.js` | test | ` M` | 35613 |
