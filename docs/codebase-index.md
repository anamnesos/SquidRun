...
| `mira/runtime/src/server.ts` | source | ` M` | 9579 |
...
| `mira/runtime/src/work-draft.ts` | source | `??` | 7539 |
...
| `mira/ui/app.js` | source | ` M` | 10347 |
| `mira/ui/index.html` | asset | ` M` | 2758 |
| `mira/ui/styles.css` | asset | ` M` | 7453 |
...
| `ui/__tests__/mira-runtime-bridge-api.test.js` | test | ` M` | 44118 |
