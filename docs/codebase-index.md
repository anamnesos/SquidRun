...
| `mira/runtime/src/model-adapter.ts` | source | ` M` | 17943 |
...
| `mira/ui/app.js` | source | ` M` | 18699 |
| `mira/ui/index.html` | asset | ` M` | 3818 |
| `mira/ui/styles.css` | asset | ` M` | 9013 |
...
| `ui/__tests__/mira-runtime-bridge-api.test.js` | test | ` M` | 72023 |
