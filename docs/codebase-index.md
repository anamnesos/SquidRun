...
| `mira/runtime/src/server.ts` | source | ` M` | 19443 |
...
| `mira/runtime/src/turn.ts` | source | `clean/tracked` | 14357 |
...
| `mira/runtime/src/work-task.ts` | source | ` M` | 70655 |
...
| `mira/ui/app.js` | source | ` M` | 39297 |
| `mira/ui/index.html` | asset | `clean/tracked` | 4783 |
...
| `ui/__tests__/mira-runtime-bridge-api.test.js` | test | ` M` | 102852 |
