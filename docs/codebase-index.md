...
| `.gitignore` | config | `clean/tracked` | 3593 |
...
| `mira/imports/reports/batch-2a-normalized-core-dry-run-v1.json` | config | `clean/tracked` | 4800 |
...
| `mira/tools/normalize-core-dry-run.js` | source | `clean/tracked` | 8980 |
...
| `ui/__tests__/mira-normalized-core-import-contract.test.js` | test | `clean/tracked` | 9442 |
...
| `ui/__tests__/mira-runtime-state-root.test.js` | test | `clean/tracked` | 11831 |
