...
| `mira/runtime/src/model-status.ts` | source | `A ` | 2317 |
...
| `mira/runtime/src/server.ts` | source | `M ` | 8700 |
...
| `mira/ui/app.js` | source | `M ` | 7814 |
| `mira/ui/index.html` | asset | `M ` | 2106 |
| `mira/ui/styles.css` | asset | `M ` | 3928 |
...
| `ui/__tests__/mira-runtime-bridge-api.test.js` | test | `M ` | 39928 |
