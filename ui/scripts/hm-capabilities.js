...
function inferCategories(fileId, description, usageLines, subcommands) {
  ...
  if (/(defi|hyperliquid|trade|trading|backtest|crypto|perp|broker|deposit|swap|bridge)/.test(haystack)) {
  ...
  if (/(github|telegram|sms|twitter|reddit|hyperliquid|defi|bridge|twilio|external)/.test(haystack)) {
