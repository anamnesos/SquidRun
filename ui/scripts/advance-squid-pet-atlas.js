 ...
 *
 * Atlas contract unchanged: 1536x1872, 8x9 grid of 192x208 frames; sampled
 * rows idle=0(6), jumping=4(5), failed=5(8), waiting=6(6), running=7(6),
 * review=8(6).
 */
...
async function main() {
  ...
  for (const pet of PETS) {
    ...
    const result = await win.webContents.executeJavaScript(
      `${TRANSFORM}(${JSON.stringify({ dataUrl })})`,
      true
    );
