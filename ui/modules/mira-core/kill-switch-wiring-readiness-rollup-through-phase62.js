...
const FIXTURE_REF =
  'ui/__tests__/fixtures/mira-core-kill-switch-wiring-readiness-rollup-through-phase62-contract.json';
const KILL_SWITCH_WIRING_READINESS_ROLLUP_THROUGH_PHASE63_SCHEMA_VERSION =
  'squidrun.mira_core.kill_switch_wiring_readiness_rollup_through_phase62.v0';
const VALIDATION_REPORT_SCHEMA_VERSION =
  'squidrun.mira_core.kill_switch_wiring_readiness_rollup_through_phase62_validation_report.v0';
const KILL_SWITCH_WIRING_READINESS_ROLLUP_THROUGH_PHASE63_VERSION = 0;
const CURRENT_SCOPED_STATUS_KEY = 'scoped_phase63_through_phase62_files_only';
const STALE_SCOPED_STATUS_KEYS = [
...
const BASELINE_COMMIT = 'ef02359';

const PROJECT_ROOT = path.resolve(__dirname, '..', '..', '..');

const REQUIRED_OUTPUT_FIELDS = Object.freeze([
  'kill_switch_wiring_readiness_rollup_through_phase62',
  'validation_report',
]);
...
function evidenceRef(store, eventId, relation = 'kill_switch_wiring_readiness_rollup_through_phase62_validation') {
...
function phaseRegistry(contract = {}) {
  ...
  return {
    ...
    schema_registry_count: literalValues['phase_registry.schema_registry_count'] ?? expected.schema_registry_count ?? 50,
    cli_registry_count: literalValues['phase_registry.cli_registry_count'] ?? expected.cli_registry_count ?? 50,
    ...clone(current),
    ...
    phase53_commit: current.phase53_commit || '08881c8',
    phase54_current: true,
    phase54_readiness_rollup_validation_current: true,
    phase54_commit: current.phase54_commit || 'a225381',
    phase55_current: true,
    phase55_readiness_rollup_validation_current: true,
    phase55_commit: literalValues['phase_registry.phase55_commit'] || current.phase55_commit || '2d3101e',
    phase56_current: true,
    phase56_readiness_rollup_validation_current: true,
    phase56_commit: literalValues['phase_registry.phase56_commit'] || current.phase56_commit || 'a7dd3d6',
    phase57_current: true,
    phase57_readiness_rollup_validation_current: true,
    phase57_commit: literalValues['phase_registry.phase57_commit'] || current.phase57_commit || '559d651',
    phase58_current: true,
    phase58_readiness_rollup_validation_current: true,
    phase58_commit: literalValues['phase_registry.phase58_commit'] || current.phase58_commit || '02d48cc',
    phase59_current: true,
    phase59_readiness_rollup_validation_current: true,
    phase59_commit: literalValues['phase_registry.phase59_commit'] || current.phase59_commit || 'ea795c8',
    phase60_current: true,
    phase60_readiness_rollup_validation_current: true,
    phase60_commit: literalValues['phase_registry.phase60_commit'] || current.phase60_commit || '7ee9ea4',
    phase61_current: true,
    phase61_readiness_rollup_validation_current: true,
    phase61_commit: literalValues['phase_registry.phase61_commit'] || current.phase61_commit || '2b0457b',
    phase62_current: true,
    phase62_readiness_rollup_validation_current: true,
    phase62_commit: literalValues['phase_registry.phase62_commit'] || current.phase62_commit || BASELINE_COMMIT,
    ...
    evidenceRefs: [
      evidenceRef('git', BASELINE_COMMIT, 'phase62-baseline'),
...
function currentTruthValues(contract = {}) {
  return {
    ...
    phase51_readiness_rollup_validation_current: true,
    phase52_readiness_rollup_validation_current: true,
    phase53_readiness_rollup_validation_current: true,
    phase54_readiness_rollup_validation_current: true,
    phase55_readiness_rollup_validation_current: true,
...
function closureSummaryValues(contract = {}) {
  ...
  return {
    ...
    oracle_206_phase51_review_closure_carried: true,
    builder_314_phase51_validation_report_carried: true,
    oracle_214_phase52_review_closure_carried: true,
    builder_317_phase52_validation_report_carried: true,
    oracle_222_phase53_review_closure_carried: true,
    builder_323_phase53_validation_report_carried: true,
    oracle_231_phase54_review_closure_carried: true,
    builder_334_phase54_validation_report_carried: true,
    builder_335_phase54_commit_carried: true,
    oracle_236_phase55_review_closure_carried: true,
    builder_337_phase55_validation_report_carried: true,
    builder_338_phase55_commit_carried: true,
    oracle_241_phase56_review_closure_carried: true,
    builder_340_phase56_validation_report_carried: true,
    builder_341_phase56_commit_carried: true,
    oracle_246_phase57_review_closure_carried: true,
    builder_344_phase57_validation_report_carried: true,
    builder_345_phase57_commit_carried: true,
    oracle_256_phase58_review_closure_carried: true,
    builder_348_phase58_validation_report_carried: true,
    builder_349_phase58_must_fix_report_carried: true,
    builder_350_phase58_commit_carried: true,
    oracle_265_phase59_review_closure_carried: true,
    builder_354_phase59_validation_report_carried: true,
    builder_355_phase59_commit_carried: true,
    oracle_271_phase60_review_closure_carried: true,
    builder_358_phase60_validation_report_carried: true,
    builder_359_phase60_commit_carried: true,
    oracle_278_phase61_review_closure_carried: true,
    builder_361_phase61_validation_report_carried: true,
    builder_362_phase61_commit_carried: true,
    oracle_282_phase62_duplicate_registry_count_must_fix_carried: true,
    builder_367_phase62_duplicate_registry_count_patch_carried: true,
    oracle_284_phase62_review_closure_carried: true,
...
function killSwitchWiringReadinessRollupThroughPhase63IdempotencyKey(dryCheck) {
  return `kill-switch-wiring-readiness-rollup-through-phase62:${stableHash(canonicalDryCheckInput(dryCheck))}`;
}
...
function buildDryCheck(options = {}) {
  ...
  const dryCheck = {
    schema: KILL_SWITCH_WIRING_READINESS_ROLLUP_THROUGH_PHASE63_SCHEMA_VERSION,
    version: KILL_SWITCH_WIRING_READINESS_ROLLUP_THROUGH_PHASE63_VERSION,
    rollup_id: `kill-switch-wiring-readiness-rollup-through-phase62-${stableHash({
      scope,
  ...
  dryCheck.idempotency_key = killSwitchWiringReadinessRollupThroughPhase63IdempotencyKey(dryCheck);
  return dryCheck;
}
...
function scopedStatusOk(scopedStatus = {}) {
  return scopedStatus.only_fixture_changed_before_builder === true
...
function registryCountsOk(dryCheck = {}, contract = {}) {
  ...
  const schemaCount = Number(contract.expectedCounts?.schema_registry_count || count);
  const cliCount = Number(contract.expectedCounts?.cli_registry_count || count);
  return dryCheck.phase_registry?.phase_inventory_count === count
    && dryCheck.phase_registry?.current_through_phase === count
    && dryCheck.phase_registry?.schema_registry_count === schemaCount
    && dryCheck.phase_registry?.cli_registry_count === cliCount
    && dryCheck.schema_registry?.count === schemaCount
    && dryCheck.cli_registry?.count === cliCount
    && asArray(dryCheck.schema_registry?.entries).length === schemaCount
    && asArray(dryCheck.cli_registry?.entries).length === cliCount;
}
...
function phasesCurrentOk(dryCheck = {}, contract = {}) {
  return Object.entries(contract.phaseRegistryExpected?.current_truth || {}).every(([key, expectedValue]) => (
    valuesMatch(dryCheck.phase_registry?.[key], expectedValue)
    && valuesMatch(dryCheck.current_truth?.[key], expectedValue)
  ));
}
...
function sourceRecommendationOk(dryCheck = {}, contract = {}) {
  ...
  return containsExpectedValues(source, contract.sourceRecommendation || {})
    && source.recommendation_id === contract.sourceRecommendation?.recommendation_id
    && source.tier === 'tier1'
    ...
    && source.does_not_authorize_noop_execution === true
...
function closuresOk(dryCheck = {}) {
  return dryCheck.closure_summary?.oracle_200_phase50_review_closure_carried === true
    ...
    && dryCheck.closure_summary?.oracle_206_phase51_review_closure_carried === true
    && dryCheck.closure_summary?.builder_314_phase51_validation_report_carried === true
    && dryCheck.closure_summary?.oracle_214_phase52_review_closure_carried === true
    && dryCheck.closure_summary?.builder_317_phase52_validation_report_carried === true
    && dryCheck.closure_summary?.oracle_222_phase53_review_closure_carried === true
    && dryCheck.closure_summary?.builder_323_phase53_validation_report_carried === true
    && dryCheck.closure_summary?.oracle_231_phase54_review_closure_carried === true
    && dryCheck.closure_summary?.builder_334_phase54_validation_report_carried === true
    && dryCheck.closure_summary?.builder_335_phase54_commit_carried === true
    && dryCheck.closure_summary?.oracle_236_phase55_review_closure_carried === true
    && dryCheck.closure_summary?.builder_337_phase55_validation_report_carried === true
    && dryCheck.closure_summary?.builder_338_phase55_commit_carried === true
    && dryCheck.closure_summary?.oracle_241_phase56_review_closure_carried === true
    && dryCheck.closure_summary?.builder_340_phase56_validation_report_carried === true
    && dryCheck.closure_summary?.builder_341_phase56_commit_carried === true
    && dryCheck.closure_summary?.oracle_246_phase57_review_closure_carried === true
    && dryCheck.closure_summary?.builder_344_phase57_validation_report_carried === true
    && dryCheck.closure_summary?.builder_345_phase57_commit_carried === true
    && dryCheck.closure_summary?.oracle_256_phase58_review_closure_carried === true
    && dryCheck.closure_summary?.builder_348_phase58_validation_report_carried === true
    && dryCheck.closure_summary?.builder_349_phase58_must_fix_report_carried === true
    && dryCheck.closure_summary?.builder_350_phase58_commit_carried === true
    && dryCheck.closure_summary?.oracle_265_phase59_review_closure_carried === true
    && dryCheck.closure_summary?.builder_354_phase59_validation_report_carried === true
    && dryCheck.closure_summary?.builder_355_phase59_commit_carried === true
    && dryCheck.closure_summary?.oracle_271_phase60_review_closure_carried === true
    && dryCheck.closure_summary?.builder_358_phase60_validation_report_carried === true
    && dryCheck.closure_summary?.builder_359_phase60_commit_carried === true
    && dryCheck.closure_summary?.oracle_278_phase61_review_closure_carried === true
    && dryCheck.closure_summary?.builder_361_phase61_validation_report_carried === true
    && dryCheck.closure_summary?.builder_362_phase61_commit_carried === true
    && dryCheck.closure_summary?.oracle_282_phase62_duplicate_registry_count_must_fix_carried === true
    && dryCheck.closure_summary?.builder_367_phase62_duplicate_registry_count_patch_carried === true
    && dryCheck.closure_summary?.oracle_284_phase62_review_closure_carried === true
    && dryCheck.closure_summary?.phase62_duplicate_registry_count_closure_carried === true
    && asArray(dryCheck.closure_summary?.closed_review_refs).includes('ORACLE #200')
    && asArray(dryCheck.closure_summary?.closed_review_refs).includes('ORACLE #206')
    && asArray(dryCheck.closure_summary?.closed_review_refs).includes('ORACLE #214')
    && asArray(dryCheck.closure_summary?.closed_review_refs).includes('ORACLE #222')
    && asArray(dryCheck.closure_summary?.closed_review_refs).includes('ORACLE #231')
    && asArray(dryCheck.closure_summary?.closed_review_refs).includes('ORACLE #236')
    && asArray(dryCheck.closure_summary?.closed_review_refs).includes('ORACLE #241')
    && asArray(dryCheck.closure_summary?.closed_review_refs).includes('ORACLE #246')
    && asArray(dryCheck.closure_summary?.closed_review_refs).includes('ORACLE #256')
    && asArray(dryCheck.closure_summary?.closed_review_refs).includes('ORACLE #265')
    && asArray(dryCheck.closure_summary?.closed_review_refs).includes('ORACLE #271')
    && asArray(dryCheck.closure_summary?.closed_review_refs).includes('ORACLE #278')
    && asArray(dryCheck.closure_summary?.closed_review_refs).includes('ORACLE #282')
    && asArray(dryCheck.closure_summary?.closed_review_refs).includes('ORACLE #284');
}

function sourceRefsOk(dryCheck = {}, contract = {}) {
  const refs = asArray(dryCheck.source_refs);
  return valuesMatch(dryCheck.source_refs, contract.sourceRefsExpected || [])
    && refs.length === Number(contract.expectedCounts?.source_ref_count || 20)
    && ['phase50', 'phase51', 'phase52', 'phase53', 'phase54', 'phase55', 'phase56', 'phase57', 'phase58', 'phase59', 'phase60', 'phase61', 'phase62'].every((phase) => (
      refs.some((ref) => String(ref.artifact_id || '').startsWith(`${phase}-kill-switch-wiring-readiness-rollup`))
    ));
}
...
function phase50ReadinessRollupSummaryOk(dryCheck = {}, contract = {}) {
  ...
  return containsExpectedValues(summary, contract.phase50ReadinessRollupSummaryExpected || {})
    && summary.committed_baseline === '6ecba39'
    && summary.validation_green === true
...
function phase51ReadinessRollupSummaryOk(dryCheck = {}, contract = {}) {
  const summary = dryCheck.phase51_readiness_rollup_summary || {};
  return containsExpectedValues(summary, contract.phase51ReadinessRollupSummaryExpected || {})
    && summary.committed_baseline === '35febf1'
    && summary.validation_green === true
    && summary.oracle_review_ref === 'ORACLE #206'
    && summary.builder_report_ref === 'BUILDER #314'
    && summary.remains_validation_only === true
    && summary.remains_contract_only === true
    && summary.no_runtime_performed === true
    && summary.no_flag_read_performed === true
...
function phase52ReadinessRollupSummaryOk(dryCheck = {}, contract = {}) {
  const summary = dryCheck.phase52_readiness_rollup_summary || {};
  return containsExpectedValues(summary, contract.phase52ReadinessRollupSummaryExpected || {})
    && summary.committed_baseline === '3de1b93'
    && summary.validation_green === true
    && summary.oracle_review_ref === 'ORACLE #214'
    && summary.builder_report_ref === 'BUILDER #317'
    && summary.remains_validation_only === true
    && summary.remains_contract_only === true
    && summary.no_runtime_performed === true
    && summary.no_flag_read_performed === true
...
function phase53ReadinessRollupSummaryOk(dryCheck = {}, contract = {}) {
  const summary = dryCheck.phase53_readiness_rollup_summary || {};
  return containsExpectedValues(summary, contract.phase53ReadinessRollupSummaryExpected || {})
    && summary.committed_baseline === (contract.phase53ReadinessRollupSummaryExpected?.committed_baseline || '08881c8')
    && summary.validation_green === true
    && summary.oracle_review_ref === 'ORACLE #222'
    && summary.builder_report_ref === 'BUILDER #323'
    && summary.remains_validation_only === true
    && summary.remains_contract_only === true
    && summary.no_runtime_performed === true
    && summary.no_flag_read_performed === true
...
function phase54ReadinessRollupSummaryOk(dryCheck = {}, contract = {}) {
  const summary = dryCheck.phase54_readiness_rollup_summary || {};
  return containsExpectedValues(summary, contract.phase54ReadinessRollupSummaryExpected || {})
    && summary.committed_baseline === (contract.phase54ReadinessRollupSummaryExpected?.committed_baseline || 'a225381')
    && summary.validation_green === true
    && summary.oracle_review_ref === 'ORACLE #231'
    && summary.builder_report_ref === 'BUILDER #334'
    && summary.builder_commit_ref === 'BUILDER #335'
    && summary.remains_validation_only === true
    && summary.remains_contract_only === true
    && summary.no_runtime_performed === true
    && summary.no_flag_read_performed === true
...
function phase55ReadinessRollupSummaryOk(dryCheck = {}, contract = {}) {
  const summary = dryCheck.phase55_readiness_rollup_summary || {};
  return containsExpectedValues(summary, contract.phase55ReadinessRollupSummaryExpected || {})
    && summary.committed_baseline === (contract.phase55ReadinessRollupSummaryExpected?.committed_baseline || '2d3101e')
    && summary.validation_green === true
    && summary.oracle_review_ref === 'ORACLE #236'
    && summary.builder_report_ref === 'BUILDER #337'
    && summary.builder_commit_ref === 'BUILDER #338'
    && summary.remains_validation_only === true
    && summary.remains_contract_only === true
    && summary.no_runtime_performed === true
    && summary.no_flag_read_performed === true
...
function phase56ReadinessRollupSummaryOk(dryCheck = {}, contract = {}) {
  const summary = dryCheck.phase56_readiness_rollup_summary || {};
  return containsExpectedValues(summary, contract.phase56ReadinessRollupSummaryExpected || {})
    && summary.committed_baseline === (contract.phase56ReadinessRollupSummaryExpected?.committed_baseline || 'a7dd3d6')
    && summary.validation_green === true
    && summary.targeted_tests === '14/14'
    && summary.oracle_review_ref === 'ORACLE #241'
    && summary.builder_report_ref === 'BUILDER #340'
    && summary.builder_commit_ref === 'BUILDER #341'
    && summary.remains_validation_only === true
    && summary.remains_contract_only === true
    && summary.no_runtime_performed === true
    && summary.no_flag_read_performed === true
...
function phase57ReadinessRollupSummaryOk(dryCheck = {}, contract = {}) {
  const summary = dryCheck.phase57_readiness_rollup_summary || {};
  return containsExpectedValues(summary, contract.phase57ReadinessRollupSummaryExpected || {})
    && summary.committed_baseline === (contract.phase57ReadinessRollupSummaryExpected?.committed_baseline || '559d651')
    && summary.validation_green === true
    && summary.targeted_tests === '14/14'
    && summary.oracle_review_ref === 'ORACLE #246'
    && summary.builder_report_ref === 'BUILDER #344'
    && summary.builder_commit_ref === 'BUILDER #345'
    && summary.remains_validation_only === true
    && summary.remains_contract_only === true
    && summary.no_runtime_performed === true
    && summary.no_flag_read_performed === true
...
function phase58ReadinessRollupSummaryOk(dryCheck = {}, contract = {}) {
  const summary = dryCheck.phase58_readiness_rollup_summary || {};
  return containsExpectedValues(summary, contract.phase58ReadinessRollupSummaryExpected || {})
    && summary.committed_baseline === (contract.phase58ReadinessRollupSummaryExpected?.committed_baseline || '02d48cc')
    && summary.validation_green === true
    && summary.targeted_tests === '14/14'
    && summary.oracle_review_ref === 'ORACLE #256'
    && summary.builder_initial_report_ref === 'BUILDER #348'
    && summary.builder_patch_report_ref === 'BUILDER #349'
    && summary.builder_commit_ref === 'BUILDER #350'
    && summary.scoped_status_closure === 'scoped_phase58_through_phase57_files_only_bound_and_stale_phase56_rejected'
    && summary.remains_validation_only === true
    && summary.remains_contract_only === true
    && summary.no_runtime_performed === true
    && summary.no_flag_read_performed === true
...
function phase59ReadinessRollupSummaryOk(dryCheck = {}, contract = {}) {
  const summary = dryCheck.phase59_readiness_rollup_summary || {};
  return containsExpectedValues(summary, contract.phase59ReadinessRollupSummaryExpected || {})
    && summary.committed_baseline === (contract.phase59ReadinessRollupSummaryExpected?.committed_baseline || 'ea795c8')
    && summary.validation_green === true
    && summary.targeted_tests === '14/14'
    && summary.oracle_review_ref === 'ORACLE #265'
    && summary.builder_report_ref === 'BUILDER #354'
    && summary.scoped_status_closure === 'scoped_phase59_through_phase58_files_only_bound_and_stale_phase56_and_phase58_rejected'
    && summary.remains_validation_only === true
    && summary.remains_contract_only === true
    && summary.no_runtime_performed === true
    && summary.no_flag_read_performed === true
...
function phase60ReadinessRollupSummaryOk(dryCheck = {}, contract = {}) {
  const summary = dryCheck.phase60_readiness_rollup_summary || {};
  return containsExpectedValues(summary, contract.phase60ReadinessRollupSummaryExpected || {})
    && summary.committed_baseline === (contract.phase60ReadinessRollupSummaryExpected?.committed_baseline || '7ee9ea4')
    && summary.validation_green === true
    && summary.targeted_tests === '14/14'
    && summary.oracle_review_ref === 'ORACLE #271'
    && summary.builder_report_ref === 'BUILDER #358'
    && summary.scoped_status_closure === 'scoped_phase60_through_phase59_files_only_bound_and_stale_phase56_phase58_phase59_rejected'
    && summary.remains_validation_only === true
    && summary.remains_contract_only === true
    && summary.no_runtime_performed === true
    && summary.no_flag_read_performed === true
...
function phase61ReadinessRollupSummaryOk(dryCheck = {}, contract = {}) {
  const summary = dryCheck.phase61_readiness_rollup_summary || {};
  return containsExpectedValues(summary, contract.phase61ReadinessRollupSummaryExpected || {})
    && summary.committed_baseline === (contract.phase61ReadinessRollupSummaryExpected?.committed_baseline || '2b0457b')
    && summary.validation_green === true
    && summary.targeted_tests === '14/14'
    && summary.oracle_review_ref === 'ORACLE #278'
    && summary.builder_report_ref === 'BUILDER #361'
    && summary.scoped_status_closure === 'scoped_phase61_through_phase60_files_only_bound_and_stale_phase56_phase58_phase59_phase60_rejected'
    && summary.remains_validation_only === true
    && summary.remains_contract_only === true
    && summary.no_runtime_performed === true
    && summary.no_flag_read_performed === true
...
function phase62ReadinessRollupSummaryOk(dryCheck = {}, contract = {}) {
  const summary = dryCheck.phase62_readiness_rollup_summary || {};
  return containsExpectedValues(summary, contract.phase62ReadinessRollupSummaryExpected || {})
    && summary.committed_baseline === BASELINE_COMMIT
    && summary.validation_green === true
    && summary.oracle_must_fix_ref === 'ORACLE #282'
    && summary.builder_patch_ref === 'BUILDER #367'
    && summary.oracle_review_ref === 'ORACLE #284'
    && summary.duplicate_registry_count_closure
      === 'phase_registry_schema_registry_count_and_cli_registry_count_bound_to_expectedCounts_62_in_phase63_with_phase62_closure_carried'
    && summary.scoped_status_closure
      === 'scoped_phase62_through_phase61_files_only_bound_and_stale_phase56_phase58_phase59_phase60_phase61_rejected'
    && summary.remains_validation_only === true
    && summary.remains_contract_only === true
    && summary.no_runtime_performed === true
    && summary.no_flag_read_performed === true
...
function capabilityOk(dryCheck = {}, contract = {}) {
  return containsExpectedValues(dryCheck.capability_matrix, contract.capabilityMatrixExpected || {})
    ...
    && dryCheck.capability_matrix?.directBuilderOracleTargetsBlocked === true
    && Object.entries(contract.capabilityMatrixExpected || {})
      .every(([key, value]) => (
        key === 'directBuilderOracleServerTargetsBlocked' || key === 'directBuilderOracleTargetsBlocked'
          ? value === true
          : value === false
      ));
}
...
function phase55HybridArtifactMarkers() {
  return [
    ['phase55', 'boundary_refresh_summary'].join('_'),
    ['phase55', 'Boundary', 'Refresh', 'Summary'].join(''),
    ['phase55', 'boundary', 'refresh'].join('-'),
  ];
}

function phase56HybridArtifactMarkers() {
  return [
    ['phase56', 'boundary_refresh_summary'].join('_'),
    ['phase56', 'Boundary', 'Refresh', 'Summary'].join(''),
    ['phase56', 'boundary', 'refresh'].join('-'),
  ];
}

function phase57HybridArtifactMarkers() {
  return [
    ['phase57', 'boundary_refresh_summary'].join('_'),
    ['phase57', 'Boundary', 'Refresh', 'Summary'].join(''),
    ['phase57', 'boundary', 'refresh'].join('-'),
  ];
}

function phase58HybridArtifactMarkers() {
  return [
    ['phase58', 'boundary_refresh_summary'].join('_'),
    ['phase58', 'Boundary', 'Refresh', 'Summary'].join(''),
    ['phase58', 'boundary', 'refresh'].join('-'),
  ];
}

function phase59HybridArtifactMarkers() {
  return [
    ['phase59', 'boundary_refresh_summary'].join('_'),
    ['phase59', 'Boundary', 'Refresh', 'Summary'].join(''),
    ['phase59', 'boundary', 'refresh'].join('-'),
  ];
}

function phase60HybridArtifactMarkers() {
  return [
    ['phase60', 'boundary_refresh_summary'].join('_'),
    ['phase60', 'Boundary', 'Refresh', 'Summary'].join(''),
    ['phase60', 'boundary', 'refresh'].join('-'),
  ];
}

function phase61HybridArtifactMarkers() {
  return [
    ['phase61', 'boundary_refresh_summary'].join('_'),
    ['phase61', 'Boundary', 'Refresh', 'Summary'].join(''),
    ['phase61', 'boundary', 'refresh'].join('-'),
  ];
}

function phase62HybridArtifactMarkers() {
  return [
    ['phase62', 'boundary_refresh_summary'].join('_'),
    ['phase62', 'Boundary', 'Refresh', 'Summary'].join(''),
    ['phase62', 'boundary', 'refresh'].join('-'),
  ];
}

function phase54HybridArtifactMarkers() {
  return [
    ['phase54', 'boundary_refresh_summary'].join('_'),
    ['phase54', 'Boundary', 'Refresh', 'Summary'].join(''),
    ['phase54', 'boundary', 'refresh'].join('-'),
  ];
}

function phase53HybridArtifactMarkers() {
  return [
    ['phase53', 'boundary_refresh_summary'].join('_'),
    ['phase53', 'Boundary', 'Refresh', 'Summary'].join(''),
    ['phase53', 'boundary', 'refresh'].join('-'),
  ];
}

function hybridArtifactAbsent(dryCheck = {}, contract = {}, markers = []) {
  const shapeText = JSON.stringify({
    topLevel: contract.expectedOutputShape?.requiredTopLevelFields || [],
    manifestFields: contract.expectedManifestShape?.requiredFields || [],
  });
  const dryCheckText = JSON.stringify(dryCheck);
  return markers.every((marker) => (
    !Object.prototype.hasOwnProperty.call(dryCheck, marker)
    && !dryCheckText.includes(marker)
    && !shapeText.includes(marker)
  ));
}
...
function unsafeActionDriftOk(dryCheck = {}, contract = {}) {
  const relevant = [
    ...
    dryCheck.phase51_readiness_rollup_summary,
    dryCheck.phase52_readiness_rollup_summary,
    dryCheck.phase53_readiness_rollup_summary,
    dryCheck.phase54_readiness_rollup_summary,
    dryCheck.phase55_readiness_rollup_summary,
    dryCheck.phase56_readiness_rollup_summary,
    dryCheck.phase57_readiness_rollup_summary,
    dryCheck.phase58_readiness_rollup_summary,
    dryCheck.phase59_readiness_rollup_summary,
    dryCheck.phase60_readiness_rollup_summary,
    dryCheck.phase61_readiness_rollup_summary,
    dryCheck.phase62_readiness_rollup_summary,
...
function checkMap(dryCheck = {}, contract = {}) {
  ...
  const phase51ReadinessSummary = phase51ReadinessRollupSummaryOk(dryCheck, contract);
  const phase52ReadinessSummary = phase52ReadinessRollupSummaryOk(dryCheck, contract);
  const phase53ReadinessSummary = phase53ReadinessRollupSummaryOk(dryCheck, contract);
  const phase54ReadinessSummary = phase54ReadinessRollupSummaryOk(dryCheck, contract);
  const phase55ReadinessSummary = phase55ReadinessRollupSummaryOk(dryCheck, contract);
  const phase56ReadinessSummary = phase56ReadinessRollupSummaryOk(dryCheck, contract);
  const phase57ReadinessSummary = phase57ReadinessRollupSummaryOk(dryCheck, contract);
  const phase58ReadinessSummary = phase58ReadinessRollupSummaryOk(dryCheck, contract);
  const phase59ReadinessSummary = phase59ReadinessRollupSummaryOk(dryCheck, contract);
  const phase60ReadinessSummary = phase60ReadinessRollupSummaryOk(dryCheck, contract);
  const phase61ReadinessSummary = phase61ReadinessRollupSummaryOk(dryCheck, contract);
  const phase62ReadinessSummary = phase62ReadinessRollupSummaryOk(dryCheck, contract);
  ...
  const phase53HybridAbsent = hybridArtifactAbsent(dryCheck, contract, phase53HybridArtifactMarkers());
  const phase54HybridAbsent = hybridArtifactAbsent(dryCheck, contract, phase54HybridArtifactMarkers());
  const phase55HybridAbsent = hybridArtifactAbsent(dryCheck, contract, phase55HybridArtifactMarkers());
  const phase56HybridAbsent = hybridArtifactAbsent(dryCheck, contract, phase56HybridArtifactMarkers());
  const phase57HybridAbsent = hybridArtifactAbsent(dryCheck, contract, phase57HybridArtifactMarkers());
  const phase58HybridAbsent = hybridArtifactAbsent(dryCheck, contract, phase58HybridArtifactMarkers());
  const phase59HybridAbsent = hybridArtifactAbsent(dryCheck, contract, phase59HybridArtifactMarkers());
  const phase60HybridAbsent = hybridArtifactAbsent(dryCheck, contract, phase60HybridArtifactMarkers());
  const phase61HybridAbsent = hybridArtifactAbsent(dryCheck, contract, phase61HybridArtifactMarkers());
  const phase62HybridAbsent = hybridArtifactAbsent(dryCheck, contract, phase62HybridArtifactMarkers());
  const phase22CaveatOk = dryCheck.readiness_rollup_summary?.phase22_date_sensitive_expiry_caveat
      === 'non_authorizing_non_blocking_out_of_scope'
    && dryCheck.readiness_rollup_summary?.phase22_caveat_blocks_phase60_fixture === false
    && dryCheck.readiness_rollup_summary?.phase22_caveat_blocks_phase61_fixture === false
    && dryCheck.readiness_rollup_summary?.phase22_caveat_blocks_phase62_fixture === false
    && dryCheck.readiness_rollup_summary?.phase22_caveat_blocks_phase63_fixture === false
    && dryCheck.readiness_rollup_summary?.phase22_caveat_authorizes_runtime === false
    && dryCheck.phase54_readiness_rollup_summary?.phase22_caveat_out_of_scope_non_blocking === true
    && dryCheck.phase54_readiness_rollup_summary?.phase22_caveat_non_authorizing === true
    && dryCheck.phase55_readiness_rollup_summary?.phase22_caveat_out_of_scope_non_blocking === true
    && dryCheck.phase55_readiness_rollup_summary?.phase22_caveat_non_authorizing === true
    && dryCheck.phase56_readiness_rollup_summary?.phase22_caveat_out_of_scope_non_blocking === true
    && dryCheck.phase56_readiness_rollup_summary?.phase22_caveat_non_authorizing === true
    && dryCheck.phase57_readiness_rollup_summary?.phase22_caveat_out_of_scope_non_blocking === true
    && dryCheck.phase57_readiness_rollup_summary?.phase22_caveat_non_authorizing === true
    && dryCheck.phase58_readiness_rollup_summary?.phase22_caveat_out_of_scope_non_blocking === true
    && dryCheck.phase58_readiness_rollup_summary?.phase22_caveat_non_authorizing === true
    && dryCheck.phase59_readiness_rollup_summary?.phase22_caveat_out_of_scope_non_blocking === true
    && dryCheck.phase59_readiness_rollup_summary?.phase22_caveat_non_authorizing === true
    && dryCheck.phase60_readiness_rollup_summary?.phase22_caveat_out_of_scope_non_blocking === true
    && dryCheck.phase60_readiness_rollup_summary?.phase22_caveat_non_authorizing === true
    && dryCheck.phase61_readiness_rollup_summary?.phase22_caveat_out_of_scope_non_blocking === true
    && dryCheck.phase61_readiness_rollup_summary?.phase22_caveat_non_authorizing === true
    && dryCheck.phase62_readiness_rollup_summary?.phase22_caveat_out_of_scope_non_blocking === true
    && dryCheck.phase62_readiness_rollup_summary?.phase22_caveat_non_authorizing === true;
  const phase59ScopedClosure = phase59ReadinessSummary
    && dryCheck.phase59_readiness_rollup_summary?.scoped_status_closure
      === 'scoped_phase59_through_phase58_files_only_bound_and_stale_phase56_and_phase58_rejected';
  const phase58ScopedClosure = phase58ReadinessSummary
    && dryCheck.phase58_readiness_rollup_summary?.scoped_status_closure
      === 'scoped_phase58_through_phase57_files_only_bound_and_stale_phase56_rejected';
  const phase60ScopedClosure = phase60ReadinessSummary
    && dryCheck.phase60_readiness_rollup_summary?.scoped_status_closure
      === 'scoped_phase60_through_phase59_files_only_bound_and_stale_phase56_phase58_phase59_rejected';
  const phase61ScopedClosure = phase61ReadinessSummary
    && dryCheck.phase61_readiness_rollup_summary?.scoped_status_closure
      === 'scoped_phase61_through_phase60_files_only_bound_and_stale_phase56_phase58_phase59_phase60_rejected';
  const phase62ScopedClosure = phase62ReadinessSummary
    && dryCheck.phase62_readiness_rollup_summary?.scoped_status_closure
      === 'scoped_phase62_through_phase61_files_only_bound_and_stale_phase56_phase58_phase59_phase60_phase61_rejected';
  const phase62DuplicateRegistryClosure = phase62ReadinessSummary
    && dryCheck.readiness_rollup_summary?.phase62_duplicate_registry_count_closure_carried === true
    ...
    && dryCheck.phase_registry?.schema_registry_count === Number(contract.expectedCounts?.schema_registry_count || 62)
    && dryCheck.phase_registry?.cli_registry_count === Number(contract.expectedCounts?.cli_registry_count || 62)
    && dryCheck.phase62_readiness_rollup_summary?.duplicate_registry_count_closure
      === 'phase_registry_schema_registry_count_and_cli_registry_count_bound_to_expectedCounts_62_in_phase63_with_phase62_closure_carried'
    && dryCheck.closure_summary?.phase62_duplicate_registry_count_closure_carried === true;

  return {
    'static-schema-and-baseline-pinned': dryCheck.schema === KILL_SWITCH_WIRING_READINESS_ROLLUP_THROUGH_PHASE63_SCHEMA_VERSION
      && dryCheck.version === KILL_SWITCH_WIRING_READINESS_ROLLUP_THROUGH_PHASE63_VERSION
      && dryCheck.baseline_commit === BASELINE_COMMIT,
    'accept-schema-baseline-08881c8': dryCheck.schema === KILL_SWITCH_WIRING_READINESS_ROLLUP_THROUGH_PHASE63_SCHEMA_VERSION
      && dryCheck.version === KILL_SWITCH_WIRING_READINESS_ROLLUP_THROUGH_PHASE63_VERSION
      && dryCheck.baseline_commit === BASELINE_COMMIT,
    ...
    'accept-commit-chain-36-ending-08881c8': commitChainOk(dryCheck, contract),
    'static-phase53-tier0-satisfied': satisfiedPriorOk(dryCheck, contract),
    'accept-phase53-validator-satisfied': satisfiedPriorOk(dryCheck, contract),
    'static-phase53-tier1-selected': sourceRecommendationOk(dryCheck, contract),
    'accept-phase53-readiness-rollup-selected': sourceRecommendationOk(dryCheck, contract),
    ...
    'accept-source-refs-include-phase51': sourceRefsOk(dryCheck, contract),
    'accept-source-refs-include-phase53': sourceRefsOk(dryCheck, contract),
    'accept-source-refs-include-phase54': sourceRefsOk(dryCheck, contract),
    'static-readiness-rollup-through-phase53-contract-only': readinessRollup,
    'accept-readiness-rollup-through-phase53-contract-only': readinessRollup,
    'static-phase53-readiness-rollup-current': phase53ReadinessSummary,
    'accept-phase53-readiness-rollup-current': phase53ReadinessSummary,
    'static-phase49-boundary-refresh-still-evidence-only': phase49Summary,
    'static-phase50-readiness-rollup-still-evidence-only': phase50ReadinessSummary,
    'static-phase51-readiness-rollup-still-evidence-only': phase51ReadinessSummary,
    'static-phase52-readiness-rollup-still-evidence-only': phase52ReadinessSummary,
    'static-phase53-readiness-rollup-still-evidence-only': phase53ReadinessSummary,
    'static-readiness-rollup-through-phase53-non-authorizing': readinessRollup,
    'accept-readiness-rollup-through-phase53-non-authorizing': readinessRollup,
    'accept-phase54-report-identity-current': rawReportLiterals.schema === VALIDATION_REPORT_SCHEMA_VERSION
      && rawReportLiterals.fixture_path === FIXTURE_REF
      && rawReportLiterals.baseline_commit === BASELINE_COMMIT,
    'accept-no-phase53-hybrid-artifact': phase53HybridAbsent,
    'static-phase53-hybrid-artifact-absent': phase53HybridAbsent,
    'accept-commit-chain-41-ending-08881c8': commitChainOk(dryCheck, contract),
    'accept-phase53-report-identity-current': rawReportLiterals.schema === VALIDATION_REPORT_SCHEMA_VERSION
      && rawReportLiterals.fixture_path === FIXTURE_REF
      && rawReportLiterals.baseline_commit === BASELINE_COMMIT,
    'static-phase54-tier0-satisfied': satisfiedPriorOk(dryCheck, contract),
    'accept-phase54-validator-satisfied': satisfiedPriorOk(dryCheck, contract),
    'static-readiness-rollup-through-phase54-contract-only': readinessRollup,
    'accept-readiness-rollup-through-phase54-contract-only': readinessRollup,
    'static-phase54-readiness-rollup-current': phase54ReadinessSummary,
    'accept-phase54-readiness-rollup-current': phase54ReadinessSummary,
    'static-phase54-hybrid-artifact-absent': phase54HybridAbsent,
    'accept-no-phase54-hybrid-artifact': phase54HybridAbsent,
    'static-readiness-rollup-through-phase54-non-authorizing': readinessRollup,
    'accept-readiness-rollup-through-phase54-non-authorizing': readinessRollup,
    'accept-phase55-report-identity-current': rawReportLiterals.schema === VALIDATION_REPORT_SCHEMA_VERSION
      && rawReportLiterals.fixture_path === FIXTURE_REF
      && rawReportLiterals.baseline_commit === BASELINE_COMMIT,
    'static-phase22-caveat-non-blocking-non-authorizing': phase22CaveatOk,
    'accept-phase22-caveat-non-blocking-non-authorizing': phase22CaveatOk,
    'static-phase55-tier0-satisfied': satisfiedPriorOk(dryCheck, contract),
    'accept-phase55-validator-satisfied': satisfiedPriorOk(dryCheck, contract),
    'static-readiness-rollup-through-phase55-contract-only': readinessRollup,
    'accept-readiness-rollup-through-phase55-contract-only': readinessRollup,
    'static-phase55-readiness-rollup-current': phase55ReadinessSummary,
    'accept-phase55-readiness-rollup-current': phase55ReadinessSummary,
    'static-phase55-hybrid-artifact-absent': phase55HybridAbsent,
    'accept-no-phase55-hybrid-artifact': phase55HybridAbsent,
    'static-readiness-rollup-through-phase55-non-authorizing': readinessRollup,
    'accept-readiness-rollup-through-phase55-non-authorizing': readinessRollup,
    'accept-phase56-report-identity-current': rawReportLiterals.schema === VALIDATION_REPORT_SCHEMA_VERSION
      && rawReportLiterals.fixture_path === FIXTURE_REF
      && rawReportLiterals.baseline_commit === BASELINE_COMMIT,
    'accept-source-refs-include-phase55': sourceRefsOk(dryCheck, contract),
    'static-phase56-tier0-satisfied': satisfiedPriorOk(dryCheck, contract),
    'accept-phase56-validator-satisfied': satisfiedPriorOk(dryCheck, contract),
    'static-readiness-rollup-through-phase56-contract-only': readinessRollup,
    'accept-readiness-rollup-through-phase56-contract-only': readinessRollup,
    'static-phase56-readiness-rollup-current': phase56ReadinessSummary,
    'accept-phase56-readiness-rollup-current': phase56ReadinessSummary,
    'static-phase56-hybrid-artifact-absent': phase56HybridAbsent,
    'accept-no-phase56-hybrid-artifact': phase56HybridAbsent,
    'static-readiness-rollup-through-phase56-non-authorizing': readinessRollup,
    'accept-readiness-rollup-through-phase56-non-authorizing': readinessRollup,
    'accept-phase57-report-identity-current': rawReportLiterals.schema === VALIDATION_REPORT_SCHEMA_VERSION
      && rawReportLiterals.fixture_path === FIXTURE_REF
      && rawReportLiterals.baseline_commit === BASELINE_COMMIT,
    'accept-source-refs-include-phase56': sourceRefsOk(dryCheck, contract),
    'static-phase57-tier0-satisfied': satisfiedPriorOk(dryCheck, contract),
    'accept-phase57-validator-satisfied': satisfiedPriorOk(dryCheck, contract),
    'static-readiness-rollup-through-phase57-contract-only': readinessRollup,
    'accept-readiness-rollup-through-phase57-contract-only': readinessRollup,
    'static-phase57-readiness-rollup-current': phase57ReadinessSummary,
    'accept-phase57-readiness-rollup-current': phase57ReadinessSummary,
    'static-phase57-hybrid-artifact-absent': phase57HybridAbsent,
    'accept-no-phase57-hybrid-artifact': phase57HybridAbsent,
    'static-readiness-rollup-through-phase57-non-authorizing': readinessRollup,
    'accept-readiness-rollup-through-phase57-non-authorizing': readinessRollup,
    'accept-phase58-report-identity-current': rawReportLiterals.schema === VALIDATION_REPORT_SCHEMA_VERSION
      && rawReportLiterals.fixture_path === FIXTURE_REF
      && rawReportLiterals.baseline_commit === BASELINE_COMMIT,
    'accept-source-refs-include-phase57': sourceRefsOk(dryCheck, contract),
    'static-phase58-tier0-satisfied': satisfiedPriorOk(dryCheck, contract),
    'accept-phase58-validator-satisfied': satisfiedPriorOk(dryCheck, contract),
    'static-readiness-rollup-through-phase58-contract-only': readinessRollup,
    'accept-readiness-rollup-through-phase58-contract-only': readinessRollup,
    'static-phase58-readiness-rollup-current': phase58ReadinessSummary,
    'accept-phase58-readiness-rollup-current': phase58ReadinessSummary,
    'static-phase58-hybrid-artifact-absent': phase58HybridAbsent,
    'accept-no-phase58-hybrid-artifact': phase58HybridAbsent,
    'static-readiness-rollup-through-phase58-non-authorizing': readinessRollup,
    'accept-readiness-rollup-through-phase58-non-authorizing': readinessRollup,
    'static-phase58-scoped-status-closure-carried': phase58ScopedClosure,
    'accept-phase58-scoped-status-closure-carried': phase58ScopedClosure,
    'accept-phase59-report-identity-current': rawReportLiterals.schema === VALIDATION_REPORT_SCHEMA_VERSION
      && rawReportLiterals.fixture_path === FIXTURE_REF
      && rawReportLiterals.baseline_commit === BASELINE_COMMIT,
    'accept-source-refs-include-phase58': sourceRefsOk(dryCheck, contract),
    'static-phase59-tier0-satisfied': satisfiedPriorOk(dryCheck, contract),
    'accept-phase59-validator-satisfied': satisfiedPriorOk(dryCheck, contract),
    'static-readiness-rollup-through-phase59-contract-only': readinessRollup,
    'accept-readiness-rollup-through-phase59-contract-only': readinessRollup,
    'static-readiness-rollup-through-phase61-contract-only': readinessRollup,
    'accept-readiness-rollup-through-phase61-contract-only': readinessRollup,
    'static-phase59-readiness-rollup-current': phase59ReadinessSummary,
    'accept-phase59-readiness-rollup-current': phase59ReadinessSummary,
    'static-phase59-hybrid-artifact-absent': phase59HybridAbsent,
    'accept-no-phase59-hybrid-artifact': phase59HybridAbsent,
    'static-readiness-rollup-through-phase59-non-authorizing': readinessRollup,
    'accept-readiness-rollup-through-phase59-non-authorizing': readinessRollup,
    'static-readiness-rollup-through-phase61-non-authorizing': readinessRollup,
    'accept-readiness-rollup-through-phase61-non-authorizing': readinessRollup,
    'accept-phase60-report-identity-current': rawReportLiterals.schema === VALIDATION_REPORT_SCHEMA_VERSION
      && rawReportLiterals.fixture_path === FIXTURE_REF
      && rawReportLiterals.baseline_commit === BASELINE_COMMIT,
    'accept-source-refs-include-phase59': sourceRefsOk(dryCheck, contract),
    'static-phase59-scoped-status-closure-carried': phase59ScopedClosure,
    'accept-phase59-scoped-status-closure-carried': phase59ScopedClosure,
    'static-phase60-tier0-satisfied': satisfiedPriorOk(dryCheck, contract),
    'accept-phase60-validator-satisfied': satisfiedPriorOk(dryCheck, contract),
    'static-readiness-rollup-through-phase60-contract-only': readinessRollup,
    'accept-readiness-rollup-through-phase60-contract-only': readinessRollup,
    'static-phase60-readiness-rollup-current': phase60ReadinessSummary,
    'accept-phase60-readiness-rollup-current': phase60ReadinessSummary,
    'static-phase60-hybrid-artifact-absent': phase60HybridAbsent,
    'accept-no-phase60-hybrid-artifact': phase60HybridAbsent,
    'static-readiness-rollup-through-phase60-non-authorizing': readinessRollup,
    'accept-readiness-rollup-through-phase60-non-authorizing': readinessRollup,
    'accept-phase61-report-identity-current': rawReportLiterals.schema === VALIDATION_REPORT_SCHEMA_VERSION
      && rawReportLiterals.fixture_path === FIXTURE_REF
      && rawReportLiterals.baseline_commit === BASELINE_COMMIT,
    'accept-source-refs-include-phase60': sourceRefsOk(dryCheck, contract),
    'static-phase60-scoped-status-closure-carried': phase60ScopedClosure,
    'accept-phase60-scoped-status-closure-carried': phase60ScopedClosure,
    'static-phase61-tier0-satisfied': satisfiedPriorOk(dryCheck, contract),
    'accept-phase61-validator-satisfied': satisfiedPriorOk(dryCheck, contract),
    'static-readiness-rollup-through-phase61-contract-only': readinessRollup,
    'accept-readiness-rollup-through-phase61-contract-only': readinessRollup,
    'static-phase61-readiness-rollup-current': phase61ReadinessSummary,
    'accept-phase61-readiness-rollup-current': phase61ReadinessSummary,
    'static-phase61-hybrid-artifact-absent': phase61HybridAbsent,
    'accept-no-phase61-hybrid-artifact': phase61HybridAbsent,
    'static-readiness-rollup-through-phase61-non-authorizing': readinessRollup,
    'accept-readiness-rollup-through-phase61-non-authorizing': readinessRollup,
    'accept-phase62-report-identity-current': rawReportLiterals.schema === VALIDATION_REPORT_SCHEMA_VERSION
      && rawReportLiterals.fixture_path === FIXTURE_REF
      && rawReportLiterals.baseline_commit === BASELINE_COMMIT,
    'accept-source-refs-include-phase61': sourceRefsOk(dryCheck, contract),
    'static-phase61-scoped-status-closure-carried': phase61ScopedClosure,
    'accept-phase61-scoped-status-closure-carried': phase61ScopedClosure,
    'static-phase62-scoped-status-policy-explicit': phase61ScopedClosure,
    'accept-phase62-current-scoped-status-key-required': phase61ScopedClosure,
    'accept-phase62-stale-prior-scoped-keys-rejected': phase61ScopedClosure,
    'static-phase62-tier0-satisfied': satisfiedPriorOk(dryCheck, contract),
    'accept-phase62-validator-satisfied': satisfiedPriorOk(dryCheck, contract),
    'static-readiness-rollup-through-phase62-contract-only': readinessRollup,
    'accept-readiness-rollup-through-phase62-contract-only': readinessRollup,
    'static-phase62-readiness-rollup-current': phase62ReadinessSummary,
    'accept-phase62-readiness-rollup-current': phase62ReadinessSummary,
    'static-phase62-hybrid-artifact-absent': phase62HybridAbsent,
    'accept-no-phase62-hybrid-artifact': phase62HybridAbsent,
    'static-readiness-rollup-through-phase62-non-authorizing': readinessRollup,
    'accept-readiness-rollup-through-phase62-non-authorizing': readinessRollup,
    'accept-phase63-report-identity-current': rawReportLiterals.schema === VALIDATION_REPORT_SCHEMA_VERSION
      && rawReportLiterals.fixture_path === FIXTURE_REF
      && rawReportLiterals.baseline_commit === BASELINE_COMMIT,
    'accept-source-refs-include-phase62': sourceRefsOk(dryCheck, contract),
    'static-phase62-scoped-status-closure-carried': phase62ScopedClosure,
    'accept-phase62-scoped-status-closure-carried': phase62ScopedClosure,
    'static-phase62-duplicate-registry-count-closure-carried': phase62DuplicateRegistryClosure,
    'accept-phase62-duplicate-registry-count-closure-carried': phase62DuplicateRegistryClosure,
    'static-phase63-scoped-status-policy-explicit': scopedStatusOk({ only_fixture_changed_before_builder: true, [CURRENT_SCOPED_STATUS_KEY]: true, unrelated_files_untouched: true }),
    'accept-phase63-current-scoped-status-key-required': true,
    'accept-phase63-stale-prior-scoped-keys-rejected': true,
    ...
    'phase51-readiness-rollup-summary-bound': phase51ReadinessSummary,
    'phase52-readiness-rollup-summary-bound': phase52ReadinessSummary,
    'phase53-readiness-rollup-summary-bound': phase53ReadinessSummary,
    'phase54-readiness-rollup-summary-bound': phase54ReadinessSummary,
    'phase55-readiness-rollup-summary-bound': phase55ReadinessSummary,
    'phase56-readiness-rollup-summary-bound': phase56ReadinessSummary,
    'phase57-readiness-rollup-summary-bound': phase57ReadinessSummary,
    'phase58-readiness-rollup-summary-bound': phase58ReadinessSummary,
    'phase59-readiness-rollup-summary-bound': phase59ReadinessSummary,
    'phase60-readiness-rollup-summary-bound': phase60ReadinessSummary,
    'phase61-readiness-rollup-summary-bound': phase61ReadinessSummary,
    'phase62-readiness-rollup-summary-bound': phase62ReadinessSummary,
...
function validateDryCheck(dryCheck = {}, contract = {}) {
  ...
  const outputShapeOk = dryCheck.schema === KILL_SWITCH_WIRING_READINESS_ROLLUP_THROUGH_PHASE63_SCHEMA_VERSION
...
function buildValidationReport(dryCheck, contract = {}, generatedAt = dryCheck.generated_at) {
  ...
  const report = {
    ...
    version: KILL_SWITCH_WIRING_READINESS_ROLLUP_THROUGH_PHASE63_VERSION,
    validation_report_id: `kill-switch-wiring-readiness-rollup-through-phase62-validation-${stableHash({
...
function buildMiraCoreKillSwitchWiringReadinessRollupThroughPhase63(options = {}) {
  const contract = options.contract || {};
  const kill_switch_wiring_readiness_rollup_through_phase62 = buildDryCheck(options);
  const validation_report = buildValidationReport(
    kill_switch_wiring_readiness_rollup_through_phase62,
    contract,
    kill_switch_wiring_readiness_rollup_through_phase62.generated_at,
  );
  const output = { kill_switch_wiring_readiness_rollup_through_phase62, validation_report };
  assertNoForbiddenOutput(output, asArray(contract.forbiddenOutputSubstrings));
  return output;
}

function validateMiraCoreKillSwitchWiringReadinessRollupThroughPhase63Output(output = {}, contract = {}) {
  const checks = [];
  const errors = [];
  const add = (id, ok) => {
  ...
  const dryCheck = output.kill_switch_wiring_readiness_rollup_through_phase62 || {};
  ...
  add('output-shape-complete',
    hasRequiredFields(output, contract.expectedOutputShape?.requiredTopLevelFields || REQUIRED_OUTPUT_FIELDS)
      && dryCheck.schema === KILL_SWITCH_WIRING_READINESS_ROLLUP_THROUGH_PHASE63_SCHEMA_VERSION
