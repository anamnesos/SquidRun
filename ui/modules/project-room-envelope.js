...
const TRUSTQUOTE_STARTUP_SOURCE_FILES = Object.freeze(['AGENTS.md', 'CLAUDE.md', 'ROLES.md', 'TRUSTQUOTE-PLAYBOOK.md']);
const TRUSTQUOTE_REQUIRED_WORK_ROOM_ROLES = Object.freeze(['builder', 'oracle']);
const TRUSTQUOTE_GENERATED_STARTUP_SOURCE_FILES = new Set(['AGENTS.md', 'ROLES.md', 'TRUSTQUOTE-PLAYBOOK.md']);
