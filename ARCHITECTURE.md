...
- ui/modules/trading/watchlist.js: Watchlist registry for the autonomous trading stack; now stores normalized ticker metadata including broker and exchange so Alpaca and IBKR assets can share the same consensus pipeline.
