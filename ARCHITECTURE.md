...
- ui/modules/mira-email-curiosity.js: Native read-only email curiosity snapshot adapter that stores connector-derived label counts and hashed recent message references for Mira scouting without reading bodies, exposing raw message IDs, sending, archiving, deleting, or modifying labels.
