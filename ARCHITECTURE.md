...
- ui/modules/trading/portfolio-tracker.js: Unified cross-market portfolio snapshot builder that aggregates optional IBKR, DeFi deposits, and future Solana-token exposure into one capital and risk view with persisted day-start / peak-equity state.
