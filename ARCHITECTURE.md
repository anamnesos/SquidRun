...
- ui/modules/mira-calendar-message-curiosity.js: Native read-only calendar/message curiosity adapter that inventories compact local calendar/message artifact metadata and connector candidates without exporting message bodies, writing calendars, sending messages, or performing network calls.
