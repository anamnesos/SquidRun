...
- `eunbyeolCheckInAutomation`, `yieldRouterAutomation`: disabled, but status still carries stale run metadata.
...
- `eunbyeolCheckInAutomation`, `yieldRouterAutomation`: disabled but still present in supervisor status with old timestamps or events.
